...
export default function ContactForm({ formType = 'contact', title, subtitle }: ContactFormProps) {
  ...
  const inputClasses = "w-full px-4 py-3.5 bg-navy/70 border border-border-dark rounded-xl text-white placeholder-medium-gray/60 focus:border-electric-blue focus:ring-2 focus:ring-electric-blue/20 focus:outline-none transition-all";
